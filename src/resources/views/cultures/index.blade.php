...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .t-head {
      display: grid;
      grid-template-columns: 2.4fr 1.2fr 1.1fr 1fr 1fr 1fr 1fr 0.9fr;
    ...
    .sc.sel {
      ...
      background: var(--fog);
      box-shadow: 0 0 0 2px rgba(74, 140, 104, .15);
    }
...
<body>
      ...
      <div class="m-body">
        ...
        <div class="m-g2">
          ...
          <div>
            ...
            <div class="m-iw">
              <span class="m-ico"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064" />
                </svg></span>
  ...
  <div class="overlay" id="delModal" onclick="closeDelBg(event)">
    <form class="del-box" id="delForm" method="POST">
        @csrf
  @method('DELETE')
      ...
      <div class="del-acts">
        ...
        <button type="submit" class="btn-del">Oui, supprimer</button>
      </div>
    </form>
  </div>
