        ...
        <div class="card">
            ...
            <form action="{{route('register')}}" method="POST" novalidate enctype="multipart/form-data" id="registrationForm">
                    ...
                    <div class="step-content" id="step2">
                        ...
                        <div class="info-box">
                            ...
                            <div>
                                ...
                                <p class="info-box-body">Téléchargez vos documents pour vérification. Formats acceptés : PDF, JPG, PNG (max 5 MB par fichier).</p>
                            </div>
                        </div>
                            ...
                            <div class="upload-zone" id="uploadZone2">
                                ...
                                <label for="diplome" class="upload-trigger">
                                    ...
                                    <div>
                                        ...
                                        <p class="upload-sub" id="fn2">PDF, JPG ou PNG — Max 5 MB</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="upload-section">
                            ...
                            <div class="upload-zone" id="uploadZone3">
                                ...
                                <label for="cin" class="upload-trigger">
                                    ...
                                    <div>
                                        <p class="upload-main">Cliquez pour télécharger</p>
                                        <p class="upload-sub" id="fn3">PDF, JPG ou PNG — Max 5 MB</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                ...
                <div class="nav-footer">
                    ...
                    <div class="btn-group">
                        <a href="/login" class="btn-cancel">Annuler</a>
    ...
    <script>
        ...
        function handleFileChange(input, zoneId, labelId) {
            ...
            if (input.files?.length > 0) {
                ...
                lbl.textContent = 'PDF, JPG ou PNG — Max 5 MB';
                lbl.style.color = '';
