...
<body class="min-h-screen flex items-center justify-center p-4 py-10">
    ...
    <div class="max-w-2xl w-full bg-[#f0f9f6] rounded-[2.5rem] shadow-[0_10px_25px_rgba(0,0,0,0.15),0_4px_6px_rgba(0,0,0,0.1)] overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-[#0c5e3d] to-[#3ab37b] p-6 border-b-[2px] border-[#9ee6b8]">
            <div class="flex flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div class="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-inner border-[3px] border-[#4ca371]">
                        <!-- Leaf icon placeholder (replace with your plant1.png) -->
                        <svg class="w-9 h-9 text-[#0c5e3d] opacity-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="text-emerald-100/90 text-xs font-medium">Rejoignez notre réseau agricole professionnel</p>
                    </div>
                </div>
                <a href="/login" class="text-emerald-100 hover:text-white text-sm font-medium transition flex items-center gap-1">
        ...
        <div class="px-8 pt-6 pb-2">
            <div class="flex items-center">
                ...
                <div class="progress-line"><div class="progress-fill" id="fill1"></div></div>
                <!-- Step 2 -->
                <div class="flex flex-col items-center gap-1">
                ...
                <div class="progress-line"><div class="progress-fill" id="fill2"></div></div>
                <!-- Step 3 -->
                <div class="flex flex-col items-center gap-1">
        ...
        <!-- Form -->
        <form action="{{route('register')}}" method="POST" enctype="multipart/form-data" id="registrationForm" class="p-6 pt-4 space-y-0">

            <!-- ═══════════════ STEP 1 ═══════════════ -->
            <div class="step-content active" id="step1">
                <p class="text-[#0a4d2e] font-semibold text-xs mb-4 uppercase tracking-wide border-t-2 border-[#9ee6b8] pt-4">
                ...
                <div class="grid grid-cols-2 gap-3 mb-5">
                    <label class="type-card selected block bg-white border-2 border-[#2b8a53] rounded-xl p-4 relative">
                        <input type="radio" name="type" value="1" checked onchange="selectType(this)">
                        <div class="flex flex-col items-center text-center gap-2">
                            <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                                <svg class="w-6 h-6 text-[#0c5e3d]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="type-checkmark absolute top-2 right-2 w-5 h-5 bg-green-600 rounded-full flex items-center justify-center">
                    ...
                    <label class="type-card block bg-white border-2 border-[#2b8a53] rounded-xl p-4 relative">
                        <input type="radio" name="type" value="2" onchange="selectType(this)">
                        <div class="flex flex-col items-center text-center gap-2">
                            <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                                <svg class="w-6 h-6 text-[#0c5e3d]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <p class="text-[#0a4d2e] font-semibold text-xs mb-3 uppercase tracking-wide border-t-2 border-[#9ee6b8] pt-4">
                    Informations Personnelles
                </p>

                <!-- Nom Complet -->
                <div class="flex items-center mb-3">
                    <label class="w-36 text-[#0a4d2e] font-bold text-sm flex-shrink-0">Nom Complet <span class="text-red-500">*</span></label>
                ...
                <!-- Email -->
                <div class="flex items-center mb-3">
                    <label class="w-36 text-[#0a4d2e] font-bold text-sm flex-shrink-0">Email <span class="text-red-500">*</span></label>
                ...
                <!-- Téléphone -->
                <div class="flex items-center mb-3">
                    <label class="w-36 text-[#0a4d2e] font-bold text-sm flex-shrink-0">Téléphone <span class="text-red-500">*</span></label>
                ...
                <!-- Ville -->
                <div class="flex items-center mb-3">
                    <label class="w-36 text-[#0a4d2e] font-bold text-sm flex-shrink-0">Ville <span class="text-red-500">*</span></label>
                ...
                <div class="flex items-center mb-3" id="specialitesField">
                    <label class="w-36 text-[#0a4d2e] font-bold text-sm flex-shrink-0">Spécialités <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-2 gap-3 mb-3">
                    <div class="flex flex-col gap-1">
                        <label class="text-[#0a4d2e] font-bold text-sm">Années d'Expérience <span class="text-red-500">*</span></label>
                        <input type="number" name="annees_experience" min="0" required
                            class="bg-white border-2 border-[#2b8a53] rounded-xl px-3 py-2 inner-soft-shadow focus:outline-none transition-all"
                            placeholder="10">
                    </div>
                    <div class="flex flex-col gap-1">
                        <label class="text-[#0a4d2e] font-bold text-sm">Tarif Horaire (DH) <span class="text-red-500">*</span></label>
                        <input type="number" name="tarif_horaire" min="0" step="50" required
                            class="bg-white border-2 border-[#2b8a53] rounded-xl px-3 py-2 inner-soft-shadow focus:outline-none transition-all"
                            placeholder="500">
                    </div>
                </div>
                ...
                <!-- Password -->
                <div class="flex items-center mb-3">
                    <label class="w-36 text-[#0a4d2e] font-bold text-sm flex-shrink-0">Mot de Passe <span class="text-red-500">*</span></label>
                ...
                <!-- Confirm Password -->
                <div class="flex items-center mb-3">
                    <label class="w-36 text-[#0a4d2e] font-bold text-sm flex-shrink-0">Confirmer <span class="text-red-500">*</span></label>
                    <div class="flex-1 relative">
                ...
                <div class="bg-white border-2 border-[#2b8a53] rounded-xl p-4 mb-2">
                    <p class="text-[#0a4d2e] font-bold text-sm mb-3">Êtes-vous disponible pour des interventions à distance ou sur site ?</p>
                    <div class="flex gap-6">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="interventions" value="1" checked
                                class="w-4 h-4 accent-[#10b981]">
                            <span class="text-gray-700 text-sm font-medium">Oui</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="interventions" value="0"
                                class="w-4 h-4 accent-[#10b981]">
            ...
            <div class="step-content" id="step2">
                ...
                <div class="bg-[#ecfdf5] border-2 border-[#9ee6b8] rounded-xl p-4 mb-5 flex items-start gap-3">
                    <svg class="w-5 h-5 text-[#0c5e3d] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        ...
                        <p class="text-xs text-[#065f46] mt-1">
                            Téléchargez vos documents pour vérification. Formats acceptés: PDF, JPG, PNG (max 5MB par fichier).
                        </p>
                    </div>
                </div>
                <!-- Upload: Diplôme -->
                    ...
                    <div class="upload-zone" id="uploadZone2">
                        ...
                        <label for="diplome"
                            ...
                            <div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                                <svg class="w-5 h-5 text-[#0c5e3d]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="step-content" id="step3">
                ...
                <div class="bg-white border-2 border-[#2b8a53] rounded-xl overflow-hidden mb-4">
                    ...
                    <div class="p-4 space-y-3">
                        <div class="flex items-center justify-between">
                            <span class="text-gray-600 text-sm">Carte Professionnelle</span>
                            <span id="doc-carte" class="text-gray-400 text-sm flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <label class="flex items-start gap-3 cursor-pointer bg-white border-2 border-[#2b8a53] rounded-xl p-4">
                    ...
                    <span class="text-sm text-gray-600">
                        ...
                        <a href="/terms" class="text-[#0c5e3d] font-semibold hover:underline">conditions d'utilisation</a>
            ...
            <div class="pt-5 border-t-2 border-[#9ee6b8] mt-5 flex items-center justify-between gap-3">
                ...
                <div class="flex gap-3 ml-auto">
                    ...
                    <button type="submit" id="submitBtn"
                        class="hidden bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold px-6 py-2.5 rounded-xl shadow-lg transition transform hover:scale-[1.02] flex items-center gap-2 text-sm">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        ...
        function populateSummary() {
            ...
            document.getElementById('summary-ville').textContent = document.querySelector('select[name="ville"]')?.value || '—';
            ...
            updateDocStatus('carte_pro', 'doc-carte', 'Carte Professionnelle');
        ...
        function selectType(radio) {
            ...
            if (radio.value === 'gestionnaire') {
                document.getElementById('specialitesField').classList.add('hidden');
                document.getElementById('typeActesField').classList.remove('hidden');
            } else {
                document.getElementById('specialitesField').classList.remove('hidden');
                document.getElementById('typeActesField').classList.add('hidden');
            }
        }
